...
Firstly, thank you for taking an interesting in contributing! Aristotle is an
...
Aristotle is one of a large number of
...
issue](https://github.com/propensive/aristotle/issues) or contact the project
...
have commit rights to the `propensive/aristotle` repository, push to a branch named
...
in extreme cases. Aristotle does not use automatic code-formatting because it
...
Aristotle&rsquo;s users. Individualism is valued, and nobody should feel
